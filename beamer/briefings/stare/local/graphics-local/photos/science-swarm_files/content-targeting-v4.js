...
{isJournal=true;}
if(!isJournal){var newtag=document.createElement("iframe");newtag.setAttribute('src',"//hawkeye4.semetricmedia.com/widgets-v4/"+campaignidstr+"/"+widgetstr);newtag.setAttribute('style','width: 100%; border: none; height:350px; background: 0; overflow: hidden');newtag.setAttribute('frameBorder','0');newtag.setAttribute('title','Related Jobs');newtag.setAttribute('id',"mdgxWidgetiFrameNews");var offset=1
...
if(isJournal){var wrapperSection=document.createElement("section");var newtag=document.createElement("iframe");newtag.setAttribute('src',"//hawkeye4.semetricmedia.com/widgets-v4/"+campaignidstr+"/"+widgetstr);newtag.setAttribute('style','width: 100%; border: none; height:350px; background: 0; overflow: hidden');newtag.setAttribute('frameBorder','0');newtag.setAttribute('id',"mdgxWidgetiFrameLg");newtag.setAttribute('title','Related Jobs');wrapperSection.appendChild(newtag);var selectNode=document.querySelector("aside[data-core-aside='right-rail'] .hawkeye-side-position-node")
