...
contains
    ...
    subroutine writeGeoElevation ( myQuarry, elevation )
        ...
        integer :: unit = 0
            ...
            call writeSpecifiers ( unit = unit, IE = "SIE", facetFile = trim ( myQuarry % facetFile ), unitsDimensions = "mm" )
            call writeTerminator ( unit = unit )
            call writeDateTime   ( unit = unit )
            ! write uuid
    ...
    subroutine writeDateTime ( unit )
        ...
        integer :: dt_values ( 1 : 8 ) = 0
            ...
            write ( unit , 100 ) dt_values ( 1 : 3 ), dt_values ( 5 : 7 )
            write ( unit , fmt = '( g0 )' ) "! /Users/dantopa/primary-repos/bitbucket/fortran-alpha/rcs/writers/new-geo/src"
            write ( unit , * )

            close ( unit )

        return
        100 format ( "!", I5, 2 ( "-", I2.2 ), I3, 2 ( ":", I2.2 ) )
