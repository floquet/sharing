...
! COVID-19 Prisoner
    ...
    integer :: dt_values ( 1 : 8 ) = 0
        ...
        call writeBashHeader ( nameAndPath="../bash-land-backward/backward-sweep.sh", header = "geo_writer.f08.",io = io_mom )
        call writeBashHeader ( nameAndPath="../bash-land-backward/harvest.sh",        header = "geo_writer.f08.",io = io_harvest )
        !call writeBashHeader ( nameAndPath= "../bash-land-forward/forward-sweep.sh", header = "geo_writer.f08.", io = io_mom )
        !call writeBashHeader ( nameAndPath= "../bash-land-forward/harvest.sh",       header = "geo_writer.f08.", io = io_harvest )
        call writeBashHeader ( nameAndPath= "../bash-land-forward/file_list.txt",    header = "geo_writer.f08.", io = io_namelist )
