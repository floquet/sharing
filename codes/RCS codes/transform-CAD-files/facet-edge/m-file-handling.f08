...
CONTAINS
    ...
    FUNCTION safeopen_readonly(filename) RESULT(fd)
        ...
        LOGICAL                                       :: opened, exists
            ...
            ELSE IF (opened) THEN
                WRITE(*,'(A,A,A)') "ERROR: Refused to open ",TRIM(filename)," for reading; file already opened."
                STOP "Program termination in module 'mFileHandling', function 'safeopen_readonly'."
            END IF
    ...
    FUNCTION safeopen_readwrite(filename) RESULT(fd)
        ...
        ELSE IF (opened) THEN
            ...
            STOP "Program termination in module 'mFileHandling', function 'safeopen_readwrite'."
        END IF
    ...
    FUNCTION safeopen_writenew(filename) RESULT(fd)
        ...
        LOGICAL                                       :: opened, exists
            ...
            IF(exists) THEN
                ...
                STOP "Program termination in module 'mFileHandling', function 'safeopen_writenew'."
            ELSE IF (opened) THEN
    ...
    FUNCTION safeopen_writeappend(filename) RESULT(fd)
        ...
        LOGICAL                                       :: opened, exists
            ...
            ELSE IF (opened) THEN
                ...
                STOP "Program termination in module 'mFileHandling', function 'safeopen_writeappend'."
            END IF
    ...
    FUNCTION safeopen_writereplace(filename) RESULT(fd)
        ...
        LOGICAL                                       :: opened, exists
            ...
            ELSE IF (opened) THEN
                WRITE(stderr,'(A,A,A)') "ERROR: ",TRIM(filename)," is already open; refused to open to prevent ", &
                                        "unintentional writing."
                STOP "Program termination in module 'mFileHandling', function 'safeopen_writereplace'."
            END IF
    ...
    FUNCTION safeopen_scratchfile() RESULT(fd)
        ...
        INTEGER                                       :: io_err
            ...
            IF(io_err .NE. 0) THEN
                WRITE(stderr,'(A)') io_message
                STOP "Program termination in module 'mFileHandling', function 'safeopen_scratchfile'."
            END IF
    ...
    SUBROUTINE close_and_delete(fd)
        ...
        IF (.NOT.opened) THEN
            ...
            STOP "Program termination in module 'mFileHandling', function 'close_and_delete'."
        END IF
        ...
        LOGICAL                                       :: named, opened
            ...
            IF (opened) THEN
                ...
                ELSE
                    ...
                    STOP "Program termination in module 'mFileHandling', function 'close_and_keep_scratchfile'."
                END IF
