...
contains
    ...
    subroutine main_process_sub ( )
        type ( model ) :: myModel
            ...
            call myModel % analyze_lengths_position_vectors ( )
            ...
            call myModel % define_edges ( )
            call myModel % computeEdgeStatistics ( )
            call myModel % write_edge_lengths ( )
            call myModel % write_debug_file ( )
