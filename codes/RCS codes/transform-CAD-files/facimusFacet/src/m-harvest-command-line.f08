...
module mHarvestCommandLine
    ...
    integer :: io_stat = 0
    character ( len = * ), parameter :: myModule = "Program crashed in module 'mHarvestCommandLine', "
...
contains
    ...
    subroutine harvest_single_command_line_argument_sub ( index, theArgument )
        ...
        character ( len = * ), parameter :: mySub = "subroutine 'harvest_single_command_line_argument'."
    ...
    subroutine error_get_command_argument_sub ( gca_status, myNumber, thisArgument, launch_command )
        ...
        character ( len = * ), intent ( in ) :: thisArgument, launch_command
