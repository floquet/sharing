...
\begin{document}
\maketitle
\abstract{Unix offers many tools for the exploration of executable files, some of which depend upon the application being compiled with debug information. A brief survey follows. The \textt{man}ual pages are included, making this document useful in siloed computing networks.}
\tableofcontents
